...
# --- 운량별 내부 모양 ---
if cloudiness == 1:
    ax.plot([cx, cx], [cy - r*0.7, cy + r*0.7], color="black", linewidth=0.8)
    ...
    wedge = patches.Wedge((cx, cy), r, 0, 90, facecolor="black", edgecolor="none")
    ax.add_patch(wedge)
    ax.plot([cx, cx], [cy - r, cy + r], color="black", linewidth=0.8)
    ...
    ax.add_patch(wedge1)
    ax.add_patch(wedge2)
    ax.plot([cx - r, cx + r], [cy, cy], color="black", linewidth=0.8)
